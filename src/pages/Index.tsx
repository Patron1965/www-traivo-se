        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
            ...
            <div className="space-y-5 text-sm md:text-base text-foreground/85 leading-[1.8]">
              ...
              <p>{t({ sv: "Vi har. Vi har planerat rutter för hand i Excel. Ringt tekniker mitt i lunchen för att flytta om jobb. Försökt fakturera från handskrivna protokoll. Vi vet exakt var det brister – för vi har levt med bristerna.", en: "We have. We’ve planned routes by hand in Excel. Called technicians during lunch to move jobs around. Tried to invoice from handwritten reports. We know exactly where it breaks — because we’ve lived with the breaks." })}</p>
