    ...
    <section className="relative overflow-hidden bg-noise px-4 sm:px-6 pt-24 pb-20 md:pt-32 md:pb-28">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <span className="font-medium uppercase tracking-[0.25em] text-foreground/80 text-xs sm:text-sm">
            {t({
        ...
        <motion.p
          ...
          className="text-foreground/85 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-12"
        >
          {t({
        ...
        >
          <div className="relative rounded-2xl border border-primary/30 bg-card/40 backdrop-blur-sm p-6 sm:p-8 shadow-[0_0_40px_hsl(var(--primary)/0.08)]">
            ...
            <p className="text-base sm:text-lg text-foreground/85 leading-relaxed mb-6 max-w-xl mx-auto">
              {t({
            ...
            <div className="mt-5 flex items-center justify-center gap-1.5 text-xs sm:text-sm text-muted-foreground">
